...
void Maxpool::maxpool_layer(ac_fixed<FIXP_CONV_W, FIXP_CONV_I, true> input[], ac_fixed<FIXP_MAXPOOL_W, FIXP_MAXPOOL_I, true> output[]) {

///// ZERO PADDING /////
	/// VERY QUESTIONABLE DECLARATION ///
	ac_fixed<FIXP_CONV_W, FIXP_CONV_I, true> pad_input[(input_size+ZERO_PADDING)*(input_size+ZERO_PADDING)*input_depth];
	/////////////////////////////////////
