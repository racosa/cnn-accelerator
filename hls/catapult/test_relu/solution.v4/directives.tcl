...
//  
//  Running on Linux xph3sei702@ocaepc53 3.16.0-4-amd64 #1 SMP Debian 3.16.43-2+deb8u3 (2017-08-15) x86_64
//  
...
solution file add ../src/relu.cpp -type C++
solution file add ../src/main.cpp -type C++
solution file add ../include/relu.hpp -type UNKNOWN
solution file add ../Makefile -type UNKNOWN
