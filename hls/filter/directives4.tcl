...
#Simple FIR - Fully Parallel Implementation
project new
...
go assembly
directive set /FIR_HARDWARE/coeffs:rsc -MAP_TO_MODULE mgc_ioport.mgc_in_wire
...
directive set /FIR_HARDWARE/coeffs -WORD_WIDTH 16
directive set /FIR_HARDWARE/core/MAC -UNROLL yes
go architect
go extract
