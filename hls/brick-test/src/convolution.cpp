...
Convolution::Convolution(const ac_fixed<FIXP_CONV_W, FIXP_CONV_I, true> *kernel,
...
void Convolution::conv_layer(ac_fixed<FIXP_CONV_W, FIXP_CONV_I, true> input[], ac_fixed<FIXP_CONV_W, FIXP_CONV_I, true> output[]) {

///// Zero padding /////

/***** VERY QUESTIONABLE DECLARATION *****/
	ac_fixed<FIXP_CONV_W, FIXP_CONV_I, true> pad_input[(input_size+2*ZERO_PADDING)*(input_size+2*ZERO_PADDING)*input_depth];
///////////////////////////////////////////
