...
typedef
    ccs_design::HDL::apply_conv ccs_DUT_wrapper;
...
public:
  ...
  sc_in<bool> clk;
  sc_in<sc_logic> rst;
  sc_out<sc_lv<16> > conv_in_rsc_addr;
  sc_out<sc_logic> conv_in_rsc_re;
  sc_in<sc_lv<10> > conv_in_rsc_data_out;
  sc_out<sc_logic> conv_in_rsc_triosy_lz;
  sc_out<sc_lv<11> > conv_out_rsc_data_in;
  sc_out<sc_lv<16> > conv_out_rsc_addr;
  sc_out<sc_logic> conv_out_rsc_we;
  sc_out<sc_logic> conv_out_rsc_triosy_lz;
public:
  ccs_DUT_wrapper(const sc_module_name& nm, const char *hdl_name)
  :
    ...
    clk("clk"), 
    rst("rst"), 
    conv_in_rsc_addr("conv_in_rsc_addr"), 
    conv_in_rsc_re("conv_in_rsc_re"), 
    conv_in_rsc_data_out("conv_in_rsc_data_out"), 
    conv_in_rsc_triosy_lz("conv_in_rsc_triosy_lz"), 
    conv_out_rsc_data_in("conv_out_rsc_data_in"), 
    conv_out_rsc_addr("conv_out_rsc_addr"), 
    conv_out_rsc_we("conv_out_rsc_we"), 
