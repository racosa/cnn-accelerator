...
go assembly
directive set /apply_conv/core/CONV_NB_K -PIPELINE_INIT_INTERVAL 1
directive set /apply_conv/core/PAD -PIPELINE_INIT_INTERVAL 1
directive set /apply_conv/core/CONV_K_D -PIPELINE_INIT_INTERVAL 1
