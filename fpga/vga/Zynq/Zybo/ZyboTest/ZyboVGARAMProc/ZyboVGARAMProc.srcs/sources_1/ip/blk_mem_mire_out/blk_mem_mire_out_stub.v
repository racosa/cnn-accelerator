...
// Command     : write_verilog -force -mode synth_stub -rename_top blk_mem_mire_out -prefix
//               blk_mem_mire_out_ blk_mem_mire_out_stub.v
...
module blk_mem_mire_out(clka, wea, addra, dina, clkb, enb, addrb, doutb)
