...
#
# Generated by export_simulation on Fri Jan 26 11:22:08 CET 2018
#
################################################################################
...
switch to the './blk_mem_mire_out.sh' script.

./blk_mem_mire_out.sh -reset_run
...
./blk_mem_mire_out.sh -noclean_files

For more information on the script, please type './blk_mem_mire_out.sh -help'.
